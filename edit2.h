...
namespace test {
    ...
    public:
        edit2(void)
        {
            ...
            courses = gcnew array<String^>{ "Discrete", "English", "DLD", "Problem solving", "" };
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->btnSchedule->Click += gcnew System::EventHandler(this, &edit2::btnSchedule_Click);
            // 
            // dgvSchedule
            // 
            ...
            this->dgvSchedule->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &edit2::dgvSchedule_CellContentClick);
            // 
            // edit2
            // 
