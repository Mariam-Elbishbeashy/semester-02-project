...
namespace test {
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->dgvSchedule->CellContentClick += gcnew System::Windows::Forms::DataGridViewCellEventHandler(this, &Form13::dgvSchedule_CellContentClick);
            // 
            // Form2
            // 
    ...
    private: System::Void Form13_Load(System::Object^ sender, System::EventArgs^ e) {
        ...
        schedule[2, 1] = "";
        schedule[3, 1] = "Lab AI";
        schedule[4, 1] = "Stat.Anal.";
        schedule[5, 1] = "SE";//software engineering
        schedule[1, 2] = "";
        schedule[2, 2] = "";
        schedule[3, 2] = "";
        schedule[4, 2] = "";
        schedule[5, 2] = "";
        schedule[1, 3] = "HCI";//human computer interaction
        schedule[2, 3] = "AI";
        schedule[3, 3] = "German I";
        schedule[4, 3] = "Lab stat.Anal.";
        schedule[5, 3] = "Lab HCI";
        schedule[1, 4] = "German I";
        schedule[2, 4] = "Lab SE";
        schedule[3, 4] = "SE";
        schedule[4, 4] = "";
        schedule[5, 4] = "";
        ...
        schedule[4, 5] = "";
        schedule[5, 5] = "";
        schedule[1, 6] = "Stat. Anal.";
        schedule[2, 6] = "German I";
        schedule[3, 6] = "";
        schedule[4, 6] = "HCI";
        schedule[5, 6] = "";
