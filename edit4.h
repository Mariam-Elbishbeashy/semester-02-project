...
namespace test {
    ...
    public ref class edit4 : public System::Windows::Forms::Form
    {
    public:
        Form^ obj;
        ref class Course {
    ...
    public:
        edit4(void)
        {
            ...
            courses = gcnew array<String^>{ "German I", "AI", "Stat. Anal.", "IMG Process", "SE" };
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->btnSchedule->Click += gcnew System::EventHandler(this, &edit4::btnSchedule_Click);
            // 
            // dgvSchedule
            // 
            ...
            this->Load += gcnew System::EventHandler(this, &edit4::edit4_Load);
    ...
    private: System::Void edit4_Load(System::Object^ sender, System::EventArgs^ e) {
    }
};
}