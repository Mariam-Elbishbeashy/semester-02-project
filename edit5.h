...
namespace test {
    ...
    public ref class edit5 : public System::Windows::Forms::Form
    {
    public:
        Form^ obj;
        ref class Course {
    ...
    public:
        edit5(void)
        {
            ...
            courses = gcnew array<String^>{ "IS&R", "Data warehouse", "Found of DS", "ERP" , "senior project" };
    ...
    private:
        ...
        void InitializeComponent(void)
        {
            ...
            this->btnSchedule->Click += gcnew System::EventHandler(this, &edit5::btnSchedule_Click);
            // 
            // dgvSchedule
            // 
            ...
            this->Load += gcnew System::EventHandler(this, &edit5::edit5_Load);
    ...
    private: System::Void edit5_Load(System::Object^ sender, System::EventArgs^ e) {
    }
};
}